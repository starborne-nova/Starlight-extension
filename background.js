...
browser.action.setBadgeBackgroundColor({ color: "#0a1f27", function() { console.log("background color changed") }, });
browser.action.setBadgeText({ text: "123", function() { console.log("badge text changed") }, });
